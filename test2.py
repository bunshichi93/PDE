        ...
        for i in range(1, dim-1):
            for j in range(1, dim-1):
                ...
                u[i][j] = 1./4.*(u[i-1][j] + u[i+1][j] + u [i][j-1] + u[i][j+1] \
                                    + h**2*rho[i][j])
                #for j in range(int(0.3*dim), int(0.6*dim)):
                    #u[i][j] = 10.
            ...
            #for i in range(int(0.3*dim), int(0.6*dim)):
                #u[i][j] = 10.
    ...
    if operation == "1":
        ...
        while True:
            ...
            if ans == "1":
                ...
                omega_ott = 2/(1 + sqrt(1 - (cos(pi*h))**2))
                print "Omega ott. = %s" % omega_ott
